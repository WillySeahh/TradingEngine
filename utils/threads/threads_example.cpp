...
int main(int, char **) {
    ...
    auto t2 = createAndStartThread(1, "dummyFunction2", dummyFunction, 15, 51, true); //this is expected to be slower because this thread will sleep, before returning from join
