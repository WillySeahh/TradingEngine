...
#ifndef TRADINGENGINE_THREAD_UTILS_HPP
#define TRADINGENGINE_THREAD_UTILS_HPP
...
//        return (pthread_setaffinity_np(pthread_self(), sizeof(cpu_set_t), &cpuset) == 0);
    ...
    inline auto createAndStartThread(int core_id, const std::string &name, T &&func, A &&... args) noexcept {
        ...
        auto t = new std::thread([&]() {
            ...
            //Use perfect forwarding or not

            //std::forward<T>(func)((std::forward<A>(args))...); //calling function on this thread with the provided arguments
...
#endif //TRADINGENGINE_THREAD_UTILS_HPP
