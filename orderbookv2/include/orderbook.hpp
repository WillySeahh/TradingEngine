...
#ifndef TRADINGENGINE_ORDERBOOK_HPP
#define TRADINGENGINE_ORDERBOOK_HPP
/**
 * @file orderbook.hpp
...
private:
    ...
    map<double, vector<unique_ptr<Order>>, less<double>> m_bids; //Sorted lowest to highest
    map<double, vector<unique_ptr<Order>>, greater<double>> m_asks; //Sorted highest to lowest
...
#endif //TRADINGENGINE_ORDERBOOK_HPP
